...
public class OtherStatementsDerived9 extends OtherStatements {

    private Condition condition;
    private OtherStatements otherStatements;
    private OtherStatements otherStatements1;

    public OtherStatementsDerived9 (Condition condition, OtherStatements otherStatements, OtherStatements otherStatements1) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("OtherStatementsDerived9(\n");
