...
public class ConstAssignmentListDerived2 extends ConstAssignmentList {

    private ConstAssignment constAssignment;

    public ConstAssignmentListDerived2 (ConstAssignment constAssignment) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ConstAssignmentListDerived2(\n");
